...
ContinuumXR community a harassment-free experience for everyone, regardless of
...
This Code of Conduct applies within all ContinuumXR community spaces,
including the GitHub organization (issues, pull requests, discussions) and
the ContinuumXR Discord server, and also applies when an individual is
officially representing the community in public spaces (e.g. posting from an
official project account, or acting as an appointed representative at an
event).
...
- **Discord:** DM `@ender9492` or contact a member of the Moderator role
- **GitHub:** open a private issue or contact [@ender9492](https://github.com/ender9492) directly
